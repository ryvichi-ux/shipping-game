...
const LEVELS = [
  ...
  },
  {
    ...
    title: "夜のランタン",
    subtitle: "ブロンズ☆2 新ギミック",
    intro: "3人（召使い・父・母）を右岸へ渡そう。相性制約なし。すべての便に召使いが必要。この面では召使いだけが船をこげます。夜の川。",
    characters: [
      "maid",
      "father",
      "mother"
  ...
  },
  {
    ...
    title: "父息子げんか",
    subtitle: "ブロンズ☆2 新ギミック",
    intro: "3人（父・母・息子A）を右岸へ渡そう。相性制約なし。父と息子Aは同じ船に乗れません。",
    characters: [
      "father",
      "mother",
      "son1"
  ...
  },
  {
    ...
    title: "夜の小舟",
    subtitle: "ブロンズ☆2 まとめ",
    intro: "4人（召使い・父・母・息子A）を右岸へ渡そう。相性制約なし。すべての便に召使いが必要。この面では召使いだけが船をこげます。左岸へ戻る便は1人まで。夜の川。",
    characters: [
      "maid",
      "father",
      "mother",
  ...
  },
  {
    ...
    title: "夜と犬の番人",
    subtitle: "ブロンズ☆3 応用",
    intro: "4人（父・母・召使い・犬）を右岸へ渡そう。犬と召使い制約。すべての便に召使いが必要。この面では召使いだけが船をこげます。夜の川。",
    characters: [
      "father",
      "mother",
      "maid",
  ...
  },
  {
    ...
    title: "母息子げんかの船",
    subtitle: "ブロンズ☆3 応用",
    intro: "4人（父・母・息子A・息子B）を右岸へ渡そう。相性制約なし。母と息子は同じ船に乗れません。",
    characters: [
      "father",
      "mother",
      "son1",
  ...
  },
  {
    ...
    title: "ランタン家族",
    subtitle: "ブロンズ☆3 応用",
    intro: "4人（召使い・父・母・娘A）を右岸へ渡そう。父娘制約。すべての便に召使いが必要。この面では召使いだけが船をこげます。夜の川。",
    characters: [
      "maid",
      "father",
      "mother",
  ...
  },
  {
    ...
    title: "召使いランタン隊",
    subtitle: "シルバー☆1 ひらめき",
    intro: "5人（召使い・父・母・息子A・娘A）を右岸へ渡そう。相性制約なし。すべての便に召使いが必要。この面では召使いだけが船をこげます。夜の川。",
    characters: [
      "maid",
      "father",
      "mother",
  ...
  },
  {
    ...
    title: "ケンカを避ける船",
    subtitle: "シルバー☆1 ひらめき",
    intro: "6人（父・母・息子A・息子B・娘A・娘B）を右岸へ渡そう。相性制約なし。父と息子は同じ船に乗れません。",
    characters: [
      "father",
      "mother",
      "son1",
  ...
  },
  {
    ...
    title: "船内の火花",
    subtitle: "シルバー☆2 変化球",
    intro: "7人（父・母・息子A・息子B・娘A・娘B・召使い）を右岸へ渡そう。父娘制約・母息子制約。父と娘は同じ船に乗れません。",
    characters: [
      "father",
      "mother",
      "son1",
  ...
  },
  {
    ...
    title: "父息子げんか船",
    subtitle: "シルバー☆2 変化球",
    intro: "4人（父・母・息子A・娘A）を右岸へ渡そう。相性制約なし。父と息子は同じ船に乗れません。",
    characters: [
      "father",
      "mother",
      "son1",
  ...
  },
  {
    ...
    title: "暗い川の大家族",
    subtitle: "シルバー☆3 熟考",
    intro: "7人（父・母・息子A・息子B・娘A・娘B・召使い）を右岸へ渡そう。父娘制約・母息子制約。すべての便に召使いが必要。この面では召使いだけが船をこげます。夜の川。",
    characters: [
      "father",
      "mother",
      "son1",
  ...
  },
  {
    ...
    title: "父娘げんか船",
    subtitle: "シルバー☆3 熟考",
    intro: "4人（父・母・娘A・娘B）を右岸へ渡そう。父娘制約。父と娘は同じ船に乗れません。",
    characters: [
      "father",
      "mother",
      "daughter1",
  ...
  },
  {
    ...
    title: "母息子げんか船",
    subtitle: "シルバー☆3 熟考",
    intro: "4人（父・母・息子A・息子B）を右岸へ渡そう。母息子制約。母と息子は同じ船に乗れません。",
    characters: [
      "father",
      "mother",
      "son1",
  ...
  },
  {
    ...
    title: "召使いの往復便",
    subtitle: "シルバー☆3 熟考",
    intro: "5人（召使い・父・母・息子A・娘A）を右岸へ渡そう。相性制約なし。すべての便に召使いが必要。この面では召使いだけが船をこげます。",
    characters: [
      "maid",
      "father",
      "mother",
  ...
  },
  {
    ...
    intro: "8人（父・母・息子A・息子B・娘A・娘B・召使い・犬）を右岸へ渡そう。父娘制約・母息子制約・犬と召使い制約。すべての便に召使いが必要。この面では召使いだけが船をこげます。重さ制限4。夜の川。",
    characters: [
      "father",
      "mother",
      "son1",
